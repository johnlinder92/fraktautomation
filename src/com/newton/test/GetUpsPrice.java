...
public class GetUpsPrice {

    public PriceList getUPSPrice(String postnummer, WebDriver driver) {
...
////
        ...
        driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
         ...
         driver.findElement(By.id("nbsBackForwardNavigationContinueButton")).click();
